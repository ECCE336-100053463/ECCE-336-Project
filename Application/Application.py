...
class StartPage(ctk.CTkFrame):
    def __init__(self, master):
        ...
        ctk.CTkLabel(self, text="Baby Monitor").pack(
...
class PageOne(ctk.CTkFrame):
    def __init__(self, master):
        ...
        ctk.CTkFrame.__init__(self, master)
        ctk.CTkLabel(self, text="Login Page:").pack(
            side="top", fill="x", pady=10)

        ctk.CTkLabel(self, text="Username:", anchor="w").pack(
            side="top", fill="x", pady=10)
        entry_1 = ctk.CTkEntry(master=self, placeholder_text="")
        entry_1.pack()

        ctk.CTkLabel(self, text="Password:", anchor="w").pack(
            side="top", fill="x", pady=10)
...
class PageTwo(ctk.CTkFrame):
    def __init__(self, master):
        ...
        ctk.CTkFrame.__init__(self, master)
        ctk.CTkLabel(self, text="Registration Page:").pack(
            side="top", fill="x")

        ctk.CTkLabel(self, text="Full Name:", anchor="w").pack(
            side="top", fill="x")
        entry_1 = ctk.CTkEntry(master=self, placeholder_text="")
        entry_1.pack()

        ctk.CTkLabel(self, text="Phone Number:",
...
class PageThree(ctk.CTkFrame):
    def __init__(self, master):
        ...
        ctk.CTkFrame.__init__(self, master)
        ctk.CTkLabel(self, text="Main Menu:").pack(
            side="top", fill="x", pady=10)
...
class PageFour(ctk.CTkFrame):
    def __init__(self, master):
        ...
        ctk.CTkFrame.__init__(self, master)
        ctk.CTkLabel(self, text="Camera Feed:").pack(
            side="top", fill="x", pady=10)
...
class PageFive(ctk.CTkFrame):
    def __init__(self, master):
        ...
        ctk.CTkFrame.__init__(self, master)
        ctk.CTkLabel(self, text="Notification Feed:").pack(
            side="top", fill="x", pady=10)

        text_1 = ctk.CTkTextbox(
            master=self, width=200, height=140)
